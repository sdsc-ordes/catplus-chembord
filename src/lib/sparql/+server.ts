...
export function getMockSparqlResults(filters?: Record<string, string>): SparqlResultRow[] {
	...
	return [
		{ s3link: { type: 'uri', value: 's3://batch/2024/05/16/25/' }, campaignName: { type: 'literal', value: 'Caffeine Synthesis Run 24' }, chemicalName: { type: 'literal', value: 'theobromine' }, smiles: { type: 'literal', value: 'CN1C=NC...' }, cas: { type: 'literal', value: '83-67-0' }, reactionName: { type: 'literal', value: 'Caffeine synthesis' }, reactionType: { type: 'literal', value: 'N-methylation' } },
		{ s3link: { type: 'uri', value: 's3://batch/2024/05/16/24/' }, campaignName: { type: 'literal', value: 'Aspirin Trial' }, chemicalName: { type: 'literal', value: 'acetylsalicylic acid' }, smiles: { type: 'literal', value: 'CC(=O)OC...' }, cas: { type: 'literal', value: '50-78-2' }, reactionName: { type: 'literal', value: 'Esterification' }, reactionType: { type: 'literal', value: 'Acetylation' } },
		//{ s3link: { type: 'uri', value: 's3://batch/2024/05/16/28/' }, campaignName: { type: 'literal', value: 'Caffeine Synthesis Run 24' }, chemicalName: { type: 'literal', value: 'methyl iodide' }, smiles: { type: 'literal', value: 'CI' }, cas: { type: 'literal', value: '74-88-4' }, reactionName: { type: 'literal', value: 'Caffeine synthesis' }, reactionType: { type: 'literal', value: 'N-methylation' } },
	];
}
